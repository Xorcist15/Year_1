...
public class AP1_Oceane {
    ...
    static String verificationValeurNonVide(Scanner input) {
        ...
        do {
            ...
            if (textNonVide.isEmpty() || textNonVide.isEmpty()) {
                // Affichage du message d'erreur
                System.out.print("Saisie vide, réessayez: ");
            }

        } while (textNonVide.isEmpty() || textNonVide.isEmpty());
    ...
    static String saisirCategorieP(int choix, String[] lesCategoriesP) {
        ...
        switch (choix) {
            ...
            case 1:
                return 0 + semiColon + lesCategoriesP[0];
            
            case 2: 
                return 1 + semiColon + lesCategoriesP[1];
            
            case 3:
                return 2 + semiColon + lesCategoriesP[2];
                
            case 4:
                return 3 + semiColon + lesCategoriesP[3];
        
            case 5:
                return 4 + semiColon + lesCategoriesP[4];
        
            case 6:
                return 5 + semiColon + lesCategoriesP[5];
    ...
    static String saisirCategorieVehicules(int choix, String[] lesCategoriesV) {
        ...
        switch (choix) {
            case 1:
                return 0 + semiColon + lesCategoriesV[0];
            case 2:
                return 1 + semiColon + lesCategoriesV[1];
            case 3:
                return 2 + semiColon + lesCategoriesV[2];
            case 4:
                return 3 + semiColon + lesCategoriesV[3];
            case 5:
                return 4 + semiColon + lesCategoriesV[4];
            case 6:
                return 5 + semiColon + lesCategoriesV[5];
            case 7:
                return 6 + semiColon + lesCategoriesV[6];
            case 8:
                return 7 + semiColon + lesCategoriesV[7];
            case 9:
                return 8 + semiColon + lesCategoriesV[8];
            case 10:
                return 9 + semiColon + lesCategoriesV[9];
            default:
                return "catégorie inexistante";
        }
    }
